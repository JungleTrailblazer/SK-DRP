...
def collate(batch):
    ...
    topic_entity, question, answer, entity_range, hops, ls= batch
    ...
    return topic_entity, question, answer, entity_range, hops, ls
...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        topic_entity, question, answer, entity_range, hops, ls = self.questions[index]
    ...
    def __init__(self, input_dir, fn, bert_name, ent2id, rel2id, batch_size, training=False):
        ...
        try:
            if bert_name == "bert-base-uncased":
                self.tokenizer = BertTokenizer.from_pretrained(os.environ.get('BERT_BASE_UNCASED', 'bert-base-uncased'))
            elif bert_name == "roberta-base":
                self.tokenizer = RobertaTokenizer.from_pretrained(os.environ.get('ROBERTA_BASE', 'roberta-base'))
            else:
        ...
        for line in open(fn):
            ...
            data.append([head, question, ans, entity_range, hop, l])
