...
def test(args):
    ...
    args.glove_pt = os.environ.get('GLOVE_PICKLE_PATH', 'data/glove/glove.840B.300d.pickle')
...
# python demo_metaqa.py --input_dir data/MetaQA --save_dir checkpoint/MetaQA/test --ckpt checkpoint/MetaQA/model_metaqa.pt
def main():
    ...
    path_abs = os.environ.get('SK_DRP_ROOT', os.path.abspath(os.path.join(os.getcwd(), '../')))
    args.save_dir = path_abs + '/' + args.save_dir
